...
#define STRING_CONFIG_H_AUTHOR "(tsxfire, SKR-mini-E3-V2.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CR-10v2"
 ...
 *    100: 100k thermistor with a 4.7k pullup and beta 4267k used by 3D passion for Nova hotend
 *    101: PT100
 * 
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 45, 0, 0.0 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT ((X_BED_SIZE) / 150)    // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT ((Y_BED_SIZE) / 150)    // Y point for Z homing when homing all axes (G28).
#endif
